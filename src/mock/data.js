...
export const aboutData = {
  ...
  paragraphTwo: 'My love for finding creative solutions to client issues first led me to consultancy and now to software development. While working closely with smaller businesses I was expected to wear many hats including editing websites. This led to my first fledgling attempts at working with HTML and CSS. I loved the experience of learning and working with code and once COVID forced me to come home to the US, I enrolled in a full-time bootcamp program. I\'m no stranger to diving head first into learning new things and look forward to my continued development.',
  ...
  list: 'Javascript, HTML5, CSS3, React, Redux, Ruby, Rails, Express, Mongoose, MongoDB, Git, Node, PostgreSQL, Heroku',
